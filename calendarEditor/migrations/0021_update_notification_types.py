...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("calendarEditor", "0020_remove_queueentry_auto_archive"),
    ]

    operations = [
        migrations.RenameField(
            model_name="notificationpreference",
            old_name="notify_job_completed",
            new_name="notify_checkout_reminder",
        ),
        migrations.RemoveField(
            model_name="notificationpreference", name="notify_job_started",
        ),
